...
:titletext: Volume 6: OGC CDB Rules for Encoding Data using OpenFlight
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/BP/CDB/openflight/1.1
...
|Internal reference number of this OGC(R) document:    16-009r4
|Version: 1.1
