:Title: Volume 6: OGC CDB Rules for Encoding CDB Models using OpenFlight (Best Practice)
:titletext: Volume 6: OGC CDB Rules for Encoding CDB Models using OpenFlight (Best Practice)
:doctype: book
:encoding: utf-8
:lang: en
:toc:
