...
[width="100%",cols="12%,14%,17%,25%,32%",options="header",]
|===
|Base a|
(O)RM texture
...
|Legacy System |PBR System
|Kind=1 |N |N |Diffuse |Diffuse

|Kind=1 |Y |N |Diffuse (assuming it is albedo, if supported) |Albedo + (O)RM
...
|Y |Y |Albedo (with deriving logic, if supported) |Albedo + (O)RM
