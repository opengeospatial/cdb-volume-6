...
<<img_ModelCoordinateSystem>>: Model Coordinate System is a screenshot footnote:[Most figures in this chapter are actual screenshots from Creator.] of Creator footnote:[Creator or CAD Creator is a Siemens product. Mention of Creator in the CDB standard IS NOT an endorsement of that product.] showing a CAD view of a semi-transparent cube.
