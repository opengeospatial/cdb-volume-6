...
*Header*: There is one header node per database file. It is always the first node in the file and represents the top of the database hierarchy and tree structure. For more information, see “Head­er Record” on page 19.
...
*Text*: A text node draws text in a string with a specified font, without injecting the actual geom­etry into the database as face nodes. This is a leaf node and therefore cannot have any children. For more information, see “Text Record” on page 47.

*Vertex*: A vertex node represents a point in space, expressed as a double precision 3D coordi­nates. Each vertex is stored in the vertex palette record. Vertex attributes include x, y, z and optionally include color, normal and texture mapping information. Vertex nodes are the chil­dren of face nodes and light point nodes. For more information, see “Vertex List Record” on page 39, “Morph Vertex List Record” on page 39 and “Vertex Palette Records” on page 66.

*Morph vertex*: A morph vertex node is a second vertex node. The vertex and morph vertex rep­resent the two endpoints of a path between which the actual vertex may be interpolated. One endpoint represents the minimum (non morphed) weighting and the other represents the maxi­mum (fully morphed) weighting. Each endpoint (or weight) is a reference into the vertex palette record. All vertex attributes may be morphed. Morph vertex nodes are the children of face nodes. For more information, see For more information, see “Morph Vertex List Record” on page 39.

*Clip region*: A clip node defines a set of clipping planes. Any geometry, of the clip node’s chil­dren, that falls outside the specified clipping planes is not displayed. For more information, see “Clip Region Record” on page 47.
...
*Level of detail*: A level of detail (LOD) node serves as a switch to turn the display of everything below it on or off based on its range from the viewer, according to its switch-in, switch-out dis­tance and center location. For more information, see “Level of Detail Record” on page 41.
...
Database palettes are not limited to supporting indirect attribute mapping. The vertex palette for example, defines a set of “shared” vertex nodes that can be indirectly referenced by multiple faces and/or light point nodes in the database. Similar to the space savings achieved by attribute palettes, the vertex palette also saves much disk space in the OpenFlight file when many geom­etry nodes share references to the same exact point in space (vertex).
...
The fields within each OpenFlight record are stored in big-endian byte order. OpenFlight data­base files have the extension “.flt” by convention.
...
|Unsigned Int |2 |2 |Length - length of the record |[red]#&#x2713;#
|Char |4 |8 |7 char ASCII ID; 0 terminates (usually set to “db”) |[red]#&#x2713;#
...
*Note:* As mentioned in “Object Record” on page 25, the object transparency is not used in the Mul­tiGen-Paradigm, Inc. modeling environment to determine the actual transparency value of a face.
...
Note: Since the length of this record is represented by an un­signed short, the maximum length of the vertex pool is 216- 1 (or 65535 bytes). If the entire vertex pool cannot fit into this size, one or more continuation records will follow. (See “Continuation Record” on page 65.) |[red]#&#x2713;#
...
Road path record attributes may also be written to an ASCII file for easy access by the applica­tion. The format of the file is described in “Road Path Files,” page 99.
...
| | | |7-31 Spare |[red]#&#x278c;#
4+|The following fields are repeated for each multitexture layer that is specified as present by the bits set in the Attribute mask field above. This mechanism allows for “sparse” multitexture layer information to be present and does not require that the information present be contiguous. |[red]#&#x2713;#
...
|1 |Header |“Header Record” on page 19 |[red]#&#x2713;#
|2 |Group |“Group Record” on page 22 |[red]#&#x2713;#
|4 |Object |“Object Record” on page 25 |[red]#&#x2713;#
|5 |Face |“Face Record” on page 26 |[red]#&#x2713;#
|10 |Push Level |“Push Level Record” on page 17 |[red]#&#x2713;#
|11 |Pop Level |“Pop Level Record” on page 17 |[red]#&#x2713;#
|14 |Degree of Freedom |“Degree of Freedom Record” on page 37 |[red]#&#x2713;#
|19 |Push Subface |“Push Subface Record” on page 17 |[red]#&#x2713;#
|20 |Pop Subface |“Pop Subface Record” on page 17 |[red]#&#x2713;#
|21 |Push Extension |“Push Extension Record” on page 17 |[red]#&#x278a;#
|22 |Pop Extension |“Pop Extension Record” on page 17 |[red]#&#x278a;#
|23 |Continuation |“Continuation Record” on page 65 |[red]#&#x2713;#
|31 |Comment |“Comment Record” on page 53 |[red]#&#x2713;#
|32 |Color Palette |“Color Palette Record” on page 70 |[red]#&#x2713;#
|33 |Long ID |“Long ID Record” on page 53 |[red]#&#x2713;#
|49 |Matrix |“Matrix Record” on page 59 |[red]#&#x2713;#
|50 |Vector |“Vector Record” on page 61 |[red]#&#x278a;#
|52 |Multitexture |“Multitexture Record” on page 54 |[red]#&#x2713;#
|53 |UV List |“UV List Record” on page 55 |[red]#&#x2713;#
|55 |Binary Separating Plane |“Binary Separating Plane Record” on page 40 |[red]#&#x2713;#
|60 |Replicate |“Replicate Record” on page 57 |[red]#&#x2713;#
|61 |Instance Reference |“Instance Reference Record” on page 19 |[red]#&#x2713;#
|62 |Instance Definition |“Instance Definition Record” on page 19 |[red]#&#x2713;#
|63 |External Reference |“External Reference Record” on page 41 |[red]#&#x2713;#
|64 |Texture Palette |“Texture Palette Record” on page 73 |[red]#&#x2713;#
|67 |Vertex Palette |“Vertex Palette Record” on page 67 |[red]#&#x2713;#
|68 |Vertex with Color |“Vertex with Color Record” on page 68 |[red]#&#x2713;#
|69 |Vertex with Color and Normal |“Vertex with Color and Normal Record” on page 68 |[red]#&#x2713;#
|70 |Vertex with Color, Normal and UV |“Vertex with Color, Normal and UV Record” on page 69 |[red]#&#x2713;#
|71 |Vertex with Color and UV |“Vertex with Color and UV Record” on page 69 |[red]#&#x2713;#
|72 |Vertex List |“Vertex List Record” on page 39 |[red]#&#x2713;#
|73 |Level of Detail |“Level of Detail Record” on page 41 |[red]#&#x2713;#
|74 |Bounding Box |“Bounding Box Record” on page 62 |[red]#&#x2713;#
|76 |Rotate About Edge |“Rotate About Edge Record” on page 59 |[red]#&#x278a;#
|78 |Translate |“Translate Record” on page 59 |[red]#&#x278a;#
|79 |Scale |“Scale Record” on page 59 |[red]#&#x278a;#
|80 |Rotate About Point |“Rotate About Point Record” on page 60 |[red]#&#x278a;#
|81 |Rotate and/or Scale to Point |“Rotate and/or Scale to Point Record” on page 60 |[red]#&#x278a;#
|82 |Put |“Put Record” on page 60 |[red]#&#x278a;#
|83 |Eyepoint and Trackplane Palette |“Eyepoint and Trackplane Palette Record” on page 73 |[red]#&#x278a;#
|84 |Mesh |“Mesh Record” on page 29 |[red]#&#x278a;#
|85 |Local Vertex Pool |“Local Vertex Pool Record” on page 30 |[red]#&#x2713;#
|86 |Mesh Primitive |“Mesh Primitive Record” on page 32 |[red]#&#x2713;#
|87 |Road Segment |“Road Segment Record” on page 44 |[red]#&#x278a;#
|88 |Road Zone |“Road Zone Record” on page 58 |[red]#&#x278a;#
|89 |Morph Vertex List |“Morph Vertex List Record” on page 39 |[red]#&#x2713;#
|90 |Linkage Palette |“Linkage Palette Record” on page 77 |[red]#&#x278a;#
|91 |Sound |“Sound Record” on page 43 |[red]#&#x278a;#
|92 |Road Path |“Road Path Record” on page 46 |[red]#&#x278a;#
|93 |Sound Palette |“Sound Palette Record” on page 80 |[red]#&#x278a;#
|94 |General Matrix |“General Matrix Record” on page 60 |[red]#&#x278a;#
|95 |Text |“Text Record” on page 47 |[red]#&#x278a;#
|96 |Switch |“Switch Record” on page 49 |[red]#&#x2713;#
|97 |Line Style Palette |“Line Style Palette Record” on page 85 |[red]#&#x278a;#
|98 |Clip Region |“Clip Region Record” on page 47 |[red]#&#x278a;#
|100 |Extension |“Extension Record” on page 51 |[red]#&#x278a;#
|101 |Light Source |“Light Source Record” on page 44 |[red]#&#x278a;#
|102 |Light Source Palette |“Light Source Palette Record” on page 81 |[red]#&#x278a;#
|103 |Reserved | |[red]#&#x278a;#
|104 |Reserved | |[red]#&#x278a;#
|105 |Bounding Sphere |“Bounding Sphere Record” on page 62 |[red]#&#x2713;#
|106 |Bounding Cylinder |“Bounding Cylinder Record” on page 62 |[red]#&#x2713;#
|107 |Bounding Convex Hull |“Bounding Convex Hull Record” on page 62 |[red]#&#x2713;#
|108 |Bounding Volume Center |“Bounding Volume Center Record” on page 63 |[red]#&#x2713;#
|109 |Bounding Volume Orientation |“Bounding Volume Orientation Record” on page 63 |[red]#&#x2713;#
|110 |Reserved | |[red]#&#x278a;#
|111 |Light Point |“Light Point Record” on page 34 |[red]#&#x278a;#
|112 |Texture Mapping Palette |“Texture Mapping Palette Record” on page 86 |[red]#&#x278a;#
|113 |Material Palette |“Material Palette Record” on page 71 |[red]#&#x2713;#
|114 |Name Table |“Name Table Record” on page 71 |[red]#&#x2713;#
|115 |Continuously Adaptive Terrain (CAT) |“CAT Record” on page 50 |[red]#&#x278a;#
|116 |CAT Data |“CAT Data Record” on page 63 |[red]#&#x278a;#
|117 |Reserved | |[red]#&#x278a;#
|118 |Reserved | |[red]#&#x278a;#
|119 |Bounding Histogram |“Bounding Histogram Record” on page 62 |[red]#&#x278a;#
|120 |Reserved | |[red]#&#x278a;#
|121 |Reserved | |[red]#&#x278a;#
|122 |Push Attribute |“Push Attribute Record” on page 18 |[red]#&#x278b;#
|123 |Pop Attribute |“Pop Attribute Record” on page 18 |[red]#&#x278b;#
|124 |Reserved | |[red]#&#x278a;#
|125 |Reserved | |[red]#&#x278a;#
|126 |Curve |“Curve Record” on page 51 |[red]#&#x278a;#
|127 |Road Construction |“Road Construction Record” on page 45 |[red]#&#x278a;#
|128 |Light Point Appearance Palette |“Light Point Appearance Palette Record” on page 82 |[red]#&#x2713;#
|129 |Light Point Animation Palette |“Light Point Animation Palette Record” on page 85 |[red]#&#x278a;#
|130 |Indexed Light Point |“Indexed Light Point Record” on page 34 |[red]#&#x2713;#
|131 |Light Point System |“Light Point System Record” on page 37 |[red]#&#x278a;#
|132 |Indexed String |“Indexed String Record” on page 53 |[red]#&#x2713;#
|133 |Shader Palette |“Shader Palette Record” on page 91 |[red]#&#x278a;#
|============================================================================================
